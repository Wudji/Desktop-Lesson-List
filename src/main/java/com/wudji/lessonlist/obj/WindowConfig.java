...
public class WindowConfig {
    ...
    private boolean temp_feature_notice;// suppress warning
    ...
    public boolean isTemp_feature_notice() {
        return temp_feature_notice;
    }

    public void setTemp_feature_notice(boolean temp_feature_notice) {
        this.temp_feature_notice = temp_feature_notice;
    }
    ...
    public boolean isEnablePoemSuggestion() {
        return enablePoemSuggestion;
    }
